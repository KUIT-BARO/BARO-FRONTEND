...
import PromiseContainer from '@shared/components/promiseContainer/PromiseContainer';

const meta: Meta<typeof PromiseContainer> = {
  title: 'Components/PromiseContainer',
  component: PromiseContainer,
  tags: ['autodocs'],
};
